import { Layout, Card, Typography, Row, Col, DatePicker, Button, Table, Space, Dropdown } from 'antd';
import { 
  DownloadOutlined, 
  SearchOutlined, 
  RedoOutlined, 
...
export const Report = () => {
  ...
  const handleSearch = () => {
    if (dates && dates[0] && dates[1]) {
      console.log("🔍 Searching data between", dates[0].format("YYYY-MM-DD"), "and", dates[1].format("YYYY-MM-DD"));
      // Filtering logic
    }
  };
