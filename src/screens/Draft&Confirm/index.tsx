...
import {
  ...
  FormOutlined,
  PlusCircleOutlined,
} from "@ant-design/icons"; // นำเข้า FormOutlined
                ...
                <Row gutter={16}>
                  <Col span={5}>
                    <Form.Item
                      id="codeR"
                      label={
                        <span style={{ color: "#657589" }}>กรอกโค้ด R</span>
                      }
                    >
                      <Select
                        style={{ height: 40 }}
              ...
              <Form layout="vertical" style={{ marginTop: 20 }}>
                ...
                >
                  ...
                  <Col span={8}>
                    <Form.Item
                      id="So2"
                      label={<span style={{ color: "#657589" }}>SO</span>}
                    >
                      <Input
                        style={{ height: 40 }}
                        value={selectedRecord.SO_INV}
