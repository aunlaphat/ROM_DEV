    ...
    "paths": {
        ...
        "/constants/get-invoice-names": {
            "get": {
                ...
                "operationId": "get-invoice-names-by-customer-id",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Customer ID",
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 4,
                        "description": "Limit for number of invoices to return (default is 4)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
